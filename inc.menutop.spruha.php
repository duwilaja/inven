				...
				<div class="main-sidebar-header main-container-1 active">
					<div class="sidemenu-logo">
						<a class="main-logo" href="home<?php echo $ext?>">
							...
							<img src="img/<?php echo $iconlogo?>" class="header-brand-img icon-logo" alt="logo">
							<img src="img/<?php echo $headlogo?>" class="header-brand-img desktop-logo theme-logo" alt="logo">
							<img src="img/<?php echo $iconlogo?>" class="header-brand-img icon-logo theme-logo" alt="logo">
						</a>
					</div>
				<!-- BEGIN menu -->
