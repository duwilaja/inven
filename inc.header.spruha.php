			...
			<div class="main-container container-fluid">
				<div class="main-header-left">
					...
					<div class="hor-logo">
						<a class="main-logo" href="home<?php echo $ext?>">
							<img src="img/<?php echo $headlogo?>" class="header-brand-img desktop-logo" alt="logo">
							<img src="img/<?php echo $headlogo?>" class="header-brand-img desktop-logo-dark"
								alt="logo">
						</a>
					</div>
				</div>
				<div class="main-header-center">
					<div class="responsive-logo">
						<a href="home<?php echo $ext?>"><img src="img/<?php echo $headlogo?>" class="mobile-logo" alt="logo"></a>
						<a href="home<?php echo $ext?>"><img src="img/<?php echo $headlogo?>" class="mobile-logo-dark"
								alt="logo"></a>
					</div>
							...
							<div class="d-flex order-lg-2 ms-auto">
										...
										<div class="main-form-search p-2">
											<div class="input-group">
												...
												<input type="text" name="cari" class="form-control"
													placeholder="">
												<button type="submit" class="btn search-btn"><svg xmlns="http://www.w3.org/2000/svg"
									...
									<div class="dropdown-menu">
										<a href="javascript:void(0)" class="dropdown-item d-flex ">
											<span class="avatar  me-3 align-self-center bg-transparent"><img
													src="spruha/assets/img/flags/french_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar  me-3 align-self-center bg-transparent"><img
													src="spruha/assets/img/flags/germany_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar me-3 align-self-center bg-transparent"><img
													src="spruha/assets/img/flags/italy_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar me-3 align-self-center bg-transparent"><img
													src="spruha/assets/img/flags/russia_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar  me-3 align-self-center bg-transparent"><img
													src="spruha/assets/img/flags/spain_flag.jpg" alt="img"></span>
											<div class="d-flex">
								...
								<div class="dropdown main-header-notification">
									<a class="nav-link icon" href="">
										...
										<span class="badge bg-danger nav-link-badge hidden lonceng">0</span>
									</a>
									<div class="dropdown-menu">
								...
								<div class="dropdown main-profile-menu">
									...
									<div class="dropdown-menu">
										<div class="header-navheading">
											<h6 class="main-notification-title"><?php echo $s_ID==""?"Noone":$s_ID?></h6>
											<p class="main-notification-text"><?php echo getVal($s_LVL,$o_ulvl)?></p>
										</div>
										...
										<a class="dropdown-item" href="#" onclick="modal(atob('<?php echo $about[0]?>'),atob('<?php echo $about[1]?>'));">
											<i class="fa fa-at"></i> About
										</a>
									</div>
								</div>
								<!-- Profile -->
